...
//        System.out.println(secondRow.getText());
    ...
    public void getSingleCellByIndex(){
        ...
        List<WebElement> singleCell = driver.findElements(By.xpath("//table[@id='table1']/tbody/tr[3]/td[2]"));
        System.out.println(singleCell.size());
    }
    ...
    // HOMEWORK CREATE A METHOD THAT ACCEPTS ROW AND COL NUMBER  AND RETURNS THE CELL AS WEBELEMENT
